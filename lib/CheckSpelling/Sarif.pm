...
sub parse_warnings {
    ...
    our $flatten;
    our %directoryToRepo;
    our $directoryToProvenanceString;
    my @results;
    ...
    while (<WARNINGS>) {
        ...
        $directoryToProvenanceString{$directory} = collectVersionControlProvenance($file) unless defined $directoryToProvenanceString{$directory};
...
my %directoryToProvenanceString = ();
...
sub main {
    ...
    if ($results) {
        ...
        our %directoryToProvenanceString;
        my @provenanceList = map { $directoryToProvenanceString{$_} } keys %directoryToProvenanceString;
